...
__all__ = [
    'eWORDTYPE_ADDED', 'SPPS_RESERVED1', 'SpeechPropertyAdaptationOn',
    'DISPID_SVRate', 'ISpeechAudio', 'DISPID_SOTCSetId',
    'ISpeechObjectTokens', 'SPAS_STOP', 'SPBINARYGRAMMAR',
    'ISpeechAudioBufferInfo', 'SECNormalConfidence', 'ISpLexicon',
    'DISPID_SpeechGrammarRules', 'SPEI_INTERFERENCE',
    'DISPID_SRRSpeakAudio', 'ISpeechPhraseRules', 'UINT_PTR',
    'DISPID_SWFEBlockAlign',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRCEBookmark', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SGRSTsItem', 'SPDKL_DefaultLocation',
    'SpeechRecognizerState', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SBSSeek', 'DISPID_SpeechObjectTokenCategory',
    'SpeechEngineProperties', 'DISPID_SPRuleParent',
    'DISPID_SVWaitUntilDone', 'DISPID_SLWType', 'SPPARTOFSPEECH',
    'eLEXTYPE_RESERVED7', 'SDTAudio', 'SRERecognition',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPPS_NotOverriden',
    'ISpEventSource', 'SAFT8kHz16BitMono',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SRCVoicePurgeEvent',
    'SPEI_RECO_OTHER_CONTEXT', 'SRSActive', 'DISPID_SVEViseme',
    'SVF_None', 'SPXRO_Alternates_SML', 'tagSPPROPERTYINFO',
    'SVF_Stressed', 'DISPID_SRCRecognizer', 'SAFT16kHz8BitStereo',
    'SFTSREngine', 'SREPropertyStringChange', 'SSFMCreateForWrite',
    'SRERequestUI', 'SP_VISEME_14', 'ISpeechPhraseInfoBuilder',
    'DISPID_SRRSaveToMemory', 'IInternetSecurityManager',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SpeechVoiceStatus',
    'DISPID_SPPsItem', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SRSNumberOfActiveRules',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SpeechObjectTokens', 'SpeechCategoryRecognizers',
    'DISPID_SPPName', 'SVP_5', 'SPEI_END_INPUT_STREAM',
    'DISPID_SPPId', 'SRATopLevel', 'SAFTCCITT_ALaw_11kHzMono',
    'SPWORDLIST', 'SPDATAKEYLOCATION', 'DISPID_SASFreeBufferSpace',
    'DISPID_SRGDictationUnload', 'DISPID_SVVolume',
    'ISpeechAudioFormat', 'SPSHT_EMAIL', 'SPXMLRESULTOPTIONS',
    'SP_VISEME_10', 'DISPID_SRRTStreamTime', 'eLEXTYPE_PRIVATE14',
    'DISPID_SPRsItem', 'SPAS_CLOSED', 'DISPID_SRStatus',
    'SPEI_MIN_SR', 'SPPS_LMA', 'DISPID_SRRDiscardResultInfo',
    'ISpeechLexiconPronunciation', 'ISpPhoneticAlphabetSelection',
    'SPDKL_CurrentConfig', 'eLEXTYPE_PRIVATE9', 'SFTInput',
    'DISPID_SDKEnumValues', 'DISPID_SRSClsidEngine',
    'eLEXTYPE_PRIVATE16', 'DISPID_SRIsUISupported',
    'ISpeechResourceLoader', 'DISPID_SLWPronunciations',
    'SAFT16kHz8BitMono', 'SPAR_Unknown',
    'DISPID_SpeechAudioBufferInfo', 'SGRSTTWildcard',
    'DISPID_SLWLangId', 'SAFT12kHz16BitMono', 'ISpRecognizer',
    'SAFT16kHz16BitStereo', 'SpShortcut', 'SPSHORTCUTPAIR',
    'DISPID_SVSyncronousSpeakTimeout', 'ISpeechLexiconWord',
    'SP_VISEME_13', 'DISPID_SWFEExtraData', 'SPAUDIOOPTIONS',
    'SRERecoOtherContext', 'SPVPRI_ALERT', 'eLEXTYPE_USER',
    'eLEXTYPE_PRIVATE7', 'DISPID_SGRClear', 'DISPID_SpeechRecognizer',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SRGIsPronounceable',
    'ISpeechRecoResult2', '_ISpeechRecoContextEvents',
    'ISpeechPhraseRule', 'SVPOver', 'SPCT_SLEEP',
    'DISPID_SRCEHypothesis', 'ISpeechRecoResultTimes',
    'SPFM_OPEN_READWRITE', 'ISpObjectToken', 'DISPID_SPAsCount',
    'SVF_Emphasis', 'SPAUDIOBUFFERINFO', 'SAFT22kHz8BitStereo',
    'DISPID_SLWs_NewEnum', 'ISpeechMemoryStream',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SVEAudioLevel',
    'DISPID_SOTId', 'SVSFParseSsml', 'DISPID_SPRNumberOfElements',
    'DISPID_SpeechGrammarRule', 'DISPID_SpeechRecoResult',
    'ISpeechLexiconPronunciations', 'DISPID_SOTCreateInstance',
    'DISPID_SVSLastBookmarkId', 'SpeechVoicePriority', 'SPEI_MIN_TTS',
    ...
    'DISPID_SRGSetWordSequenceData', 'SPPS_Noun', 'ISpDataKey',
    'DISPID_SASNonBlockingIO', 'DISPID_SVSpeak', 'STSF_FlagCreate',
    'DISPID_SPIReplacements', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SOTIsUISupported', 'eWORDTYPE_DELETED', 'DISPID_SVEWord',
    ...
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SRRecognizer',
    'SSFMOpenForRead', 'STCAll', 'DISPID_SVVoice', 'SPSInterjection',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SAFTNoAssignedFormat',
    'SP_VISEME_7', 'SPWAVEFORMATTYPE', 'SAFT32kHz8BitMono',
    'SASPause', 'DISPID_SWFEFormatTag', 'SITooFast', 'SpObjectToken',
    'DISPID_SPPs_NewEnum', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SLGetGenerationChange', 'DISPID_SRGSetTextSelection',
    'DISPID_SLWsCount', 'SDA_Two_Trailing_Spaces', 'SPPS_Unknown',
    'ISpeechObjectToken', 'DISPID_SLPs_NewEnum', 'SPRST_NUM_STATES',
    'SpeechTokenKeyUI', 'ISpProperties', 'SVP_16', 'DISPID_SLPsItem',
    'DISPID_SPRText', 'eLEXTYPE_PRIVATE18',
    'ISpeechGrammarRuleStateTransitions', 'SRESoundEnd',
    'SAFT8kHz16BitStereo', 'SREAllEvents', 'DISPID_SRCESoundStart',
    'SPPS_Modifier', 'SVP_18', 'SpeechRecognitionType',
    'DISPID_SRGRecoContext', 'SREInterference',
    'SpUnCompressedLexicon', 'SPEI_VISEME', 'SPEI_MAX_SR',
    'DISPIDSPTSI_ActiveOffset', 'SpeechRecoContextState',
    'SRADefaultToActive', 'ISpeechPhraseInfo',
    'DISPID_SRCEFalseRecognition', 'SpeechDisplayAttributes',
    'DISPID_SPCIdToPhone', 'SpSharedRecoContext',
    'DISPID_SpeechPhraseAlternate', 'SAFTCCITT_uLaw_22kHzMono',
    'SVP_9', 'SRESoundStart', 'SREStateChange', 'DISPID_SGRsAdd',
    'SPFM_CREATE', 'SASClosed', 'SP_VISEME_20',
    'SpeechGrammarWordType', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SLGetPronunciations', 'DISPID_SRCEEnginePrivate',
    'DISPID_SVSCurrentStreamNumber', 'ISpeechMMSysAudio',
    'DISPID_SGRSTNextState', 'DISPID_SRCCreateGrammar', 'SPWORD',
    'DISPID_SLPLangId', 'SINoSignal', 'DISPID_SPEEngineConfidence',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SRCEventInterests',
    ...
    'DISPID_SLRemovePronunciation', 'DISPID_SRRTTickCount',
    'DISPID_SPEAudioSizeBytes', 'SAFT32kHz16BitMono',
    'SECFIgnoreWidth', 'SAFT24kHz16BitStereo',
    'DISPID_SABufferNotifySize', 'DISPID_SRRTLength',
    'SPPROPERTYINFO', 'DISPID_SpeechLexiconProns',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SpeechMemoryStream',
    'SAFT8kHz8BitStereo', 'DISPID_SpeechRecoResult2',
    'DISPID_SGRsDynamic', 'SPBO_AHEAD', 'SPFM_CREATE_ALWAYS',
    'SPBOOKMARKOPTIONS', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SVP_14', 'SPPS_RESERVED3', 'DISPID_SRRAudioFormat',
    'SpeechWordPronounceable', 'ISpeechPhraseProperty',
    'SPEI_REQUEST_UI', 'SPFM_OPEN_READONLY', '_SPAUDIOSTATE',
    'ISpeechPhraseReplacement', 'DISPID_SLPSymbolic',
    'DISPID_SPPParent', 'SpObjectTokenCategory',
    'SSSPTRelativeToStart', 'DISPID_SGRId', 'DISPID_SOTCategory',
    'SpeechBookmarkOptions', 'SAFT11kHz16BitMono', 'DISPID_SLPType',
    'DISPID_SpeechObjectToken', 'SpSharedRecognizer',
    'SDA_No_Trailing_Space', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SFSClose', 'DISPID_SRCResume', 'SPEI_RESERVED6',
    'SREPhraseStart', 'SPAR_High', 'SAFT32kHz8BitStereo',
    'SpeechFormatType', 'DISPID_SpeechPhraseInfo', 'SPEI_SOUND_START',
    'SPEI_RESERVED3', 'DISPID_SpeechRecoContextEvents',
    'ISpRecoContext', 'SpPhraseInfoBuilder',
    'SpeechSpecialTransitionType', 'DISPID_SpeechLexiconWord',
    'ISpStream', 'SPLEXICONTYPE', 'DISPID_SABufferInfo',
    'DISPID_SPCPhoneToId', 'SpeechGrammarState', 'SLODynamic',
    'SAFTADPCM_22kHzStereo', 'SPEI_UNDEFINED',
    'SWPUnknownWordPronounceable', 'STSF_CommonAppData',
    'DISPID_SpeechAudioStatus', 'DISPID_SVStatus',
    'SAFTADPCM_11kHzMono', 'SPSHORTCUTTYPE', 'DISPID_SpeechAudio',
    'SPAR_Low', 'SpeechLoadOption', 'SPGS_EXCLUSIVE',
    'DISPID_SREmulateRecognition', 'SPSERIALIZEDPHRASE', 'SWTDeleted',
    'DISPID_SAFType', 'DISPID_SPIAudioStreamPosition',
    'SAFTGSM610_22kHzMono', '_ISpeechVoiceEvents', 'SP_VISEME_2',
    'SPAUDIOSTATE', 'DISPIDSPRG', 'SAFT12kHz16BitStereo',
    'SVEEndInputStream', 'SAFTNonStandardFormat', 'SDTAll',
    'SGDSActive', 'SPPS_Interjection', 'SVP_13', 'DISPID_SAFGuid',
    'SAFTADPCM_44kHzStereo', 'SP_VISEME_11', 'SRTEmulated',
    'SAFTCCITT_uLaw_44kHzStereo', 'SVEPrivate',
    'SpeechAudioFormatType', 'SpeechCategoryRecoProfiles',
    'SAFT8kHz8BitMono', 'SpeechAudioProperties', 'SPPS_RESERVED2',
    'DISPID_SVAudioOutputStream', 'DISPID_SpeechBaseStream',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SFSOpen',
    'ISpeechPhraseElement', 'SPPHRASEREPLACEMENT',
    'eLEXTYPE_PRIVATE5', 'ISpeechObjectTokenCategory',
    'DISPID_SDKOpenKey', 'ISpRecoCategory',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SLWWord',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SVSInputWordLength',
    'SPRULE', 'DISPID_SRGCommit', 'DISPID_SDKGetlongValue',
    'SAFTGSM610_44kHzMono', 'SVSFUnusedFlags', 'SpeechVisemeType',
    'DISPID_SRRAudio', 'eLEXTYPE_PRIVATE11',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SGRsItem',
    'SpeechGrammarTagDictation', 'SAFT16kHz16BitMono',
    'SAFTCCITT_uLaw_8kHzMono', 'SPAUDIOSTATUS', 'DISPID_SRCESoundEnd',
    'SpeechTokenValueCLSID', 'SPSNotOverriden', 'SPPS_RESERVED4',
    'SRTSMLTimeout', 'DISPID_SVPause', 'SBONone', 'SPSLMA',
    'SPVOICESTATUS', 'SREAdaptation', 'SAFTText', 'SPSVerb',
    'SAFT48kHz8BitMono', 'ISpeechTextSelectionInformation',
    'DISPIDSPTSI', 'SPRST_INACTIVE_WITH_PURGE', 'SPVPRI_OVER',
    'SSSPTRelativeToCurrentPosition', 'SVP_12', 'DISPID_SMSSetData',
    'SpeechGrammarRuleStateTransitionType',
    'Speech_StreamPos_RealTime', 'DISPID_SGRSTText', 'SpMMAudioIn',
    'DISPID_SPCLangId', 'SECFEmulateResult', 'SPCT_SUB_COMMAND',
    'DISPID_SPRFirstElement', 'SGDisplay', 'SPSModifier',
    ...
    'SpeechTokenKeyFiles', 'eLEXTYPE_PRIVATE12', 'SPFM_NUM_MODES',
    'tagSPTEXTSELECTIONINFO', 'SpeechAudioState', 'ISpRecoGrammar',
    'SECFIgnoreCase', 'SGRSTTEpsilon', 'DISPID_SCSBaseStream',
    'SPEI_SOUND_END', 'DISPID_SVGetVoices', 'SPWF_SRENGINE',
    'ISpeechLexiconWords', 'SPSEMANTICERRORINFO',
    'DISPID_SDKDeleteKey', 'DISPID_SRCAudioInInterferenceStatus',
    'SPPS_Function', 'SPADAPTATIONRELEVANCE', 'SpeechRecoEvents',
    'SPEI_RESERVED2', 'DISPID_SWFESamplesPerSec',
    'DISPID_SpeechGrammarRuleState', 'SpInProcRecoContext',
    'DISPID_SOTDisplayUI', 'SpeechVoiceSkipTypeSentence',
    'SP_VISEME_19', 'DISPID_SMSADeviceId', 'eLEXTYPE_PRIVATE4',
    'DISPID_SPPValue', 'SDTProperty', 'SGSExclusive', 'SPVPRIORITY',
    'SP_VISEME_16', 'DISPID_SRGetRecognizers', 'SAFT44kHz16BitMono',
    'SDTLexicalForm', 'DISPID_SDKDeleteValue', 'SP_VISEME_4',
    'SPRECORESULTTIMES', 'DISPID_SPIEnginePrivateData',
    'DISPID_SOTsCount', 'STSF_AppData',
    'DISPID_SGRSAddSpecialTransition', '__MIDL_IWinTypes_0009',
    'SPLOADOPTIONS', 'ISpRecognizer3', 'SVP_21', 'SPSHT_Unknown',
    'DISPID_SpeechPhraseProperty', 'DISPID_SVSLastResult',
    'SRTReSent', 'SRSActiveAlways', 'DISPID_SGRAddResource',
    'DISPID_SPAStartElementInResult', 'DISPID_SPPEngineConfidence',
    'SAFT11kHz8BitStereo', 'SP_VISEME_21', 'SVP_0', 'SpMMAudioEnum',
    'SpMMAudioOut', 'SAFTADPCM_11kHzStereo', 'ISpeechLexicon',
    'ISpeechRecoResult', 'DISPID_SRCRequestedUIType', 'SPVPRI_NORMAL',
    'tagSTATSTG', 'SITooLoud', 'eLEXTYPE_RESERVED8',
    'SPINTERFERENCE_NOISE', 'SECLowConfidence',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SDKLCurrentConfig',
    'ISpeechRecognizer', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SVAudioOutput', 'SVP_2', '_RemotableHandle',
    'DISPID_SWFEChannels', 'DISPID_SOTGetStorageFileName',
    'SpTextSelectionInformation', 'SPINTERFERENCE_NONE',
    'DISPID_SMSAMMHandle', 'DISPID_SGRSTPropertyId', 'SREHypothesis',
    'SREBookmark', 'DISPID_SRGReset', 'SAFTADPCM_8kHzStereo',
    'SAFTGSM610_8kHzMono', 'DISPID_SPIEngineId',
    'DISPID_SPEActualConfidence', 'SPSEMANTICFORMAT',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SRCEStartStream',
    'ISpeechDataKey', 'SREFalseRecognition',
    'DISPID_SpeechPhraseReplacements', 'SGSEnabled',
    'ISpeechPhraseProperties', 'SPGS_DISABLED', 'SVSFDefault',
    ...
    'DISPID_SWFEBitsPerSample', 'SLTApp', 'ISequentialStream',
    'SpeechRegistryUserRoot', 'DISPID_SVSPhonemeId', 'SITooSlow',
    'DISPID_SVESentenceBoundary', 'DISPID_SPIGetText',
    'ISpeechCustomStream', 'DISPID_SpeechPhraseRule',
    'ISpPhoneticAlphabetConverter', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SABIMinNotification', 'DISPID_SPAsItem',
    'SpeechTokenShellFolder', 'SREAudioLevel', 'eLEXTYPE_PRIVATE10',
    'eLEXTYPE_LETTERTOSOUND', 'SpeechPropertyResponseSpeed',
    'SAFT22kHz16BitMono', 'DISPID_SOTsItem', 'DISPID_SVEVoiceChange',
    'DISPID_SGRSRule', 'DISPID_SPELexicalForm',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SGRInitialState',
    'SpeechTokenContext', 'SITooQuiet', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SVEBookmark', 'SpPhoneConverter', 'DISPID_SASetState',
    'DISPID_SAStatus', 'DISPID_SPILanguageId',
    'DISPID_SPISaveToMemory', 'DISPID_SpeechVoice', 'SVSFlagsAsync',
    'SPPHRASERULE', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SASState', 'SVEPhoneme', 'ISpAudio', 'SAFTADPCM_8kHzMono',
    'SGDSActiveWithAutoPause', 'eLEXTYPE_MORPHOLOGY',
    'SPCONTEXTSTATE', 'SP_VISEME_17', 'SpeechWordType',
    'DISPID_SRCEPhraseStart', 'eLEXTYPE_PRIVATE13',
    'ISpeechGrammarRuleState', 'SGSDisabled', 'SVSFIsXML',
    'Speech_Max_Word_Length', 'SPGS_ENABLED', 'DISPID_SDKEnumKeys',
    'DISPID_SPIAudioSizeTime', 'SPSUnknown',
    'SGLexicalNoSpecialChars', 'ISpeechPhoneConverter',
    'SpeechRuleState', 'DISPID_SPACommit', 'SPAS_PAUSE',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SLWsItem',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SLAddPronunciationByPhoneIds', 'SRARoot',
    'DISPID_SpeechLexicon', 'SVSFNLPSpeakPunc', 'SpeechAllElements',
    'SpResourceManager', 'SVESentenceBoundary', 'SVPAlert',
    'SDKLLocalMachine', 'DISPID_SVSRunningState',
    'SPEI_TTS_AUDIO_LEVEL', 'SpStream', 'DISPID_SABIBufferSize',
    'SPPHRASEELEMENT', 'SPWT_LEXICAL',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SRSetPropertyNumber', 'SPEI_ADAPTATION', 'SPBO_PAUSE',
    'DISPID_SPPConfidence', 'SAFTGSM610_11kHzMono',
    'DISPID_SPARecoResult', 'SpNullPhoneConverter',
    'DISPID_SpeechPhoneConverter', 'SREStreamEnd',
    'DISPID_SOTs_NewEnum', 'IStream', 'SRTAutopause',
    'DISPID_SRRPhraseInfo', 'DISPID_SPIRule', 'SPSNoun',
    'SPWT_DISPLAY', 'SpeechEngineConfidence', 'SAFT48kHz16BitMono',
    'DISPID_SRGDictationLoad', 'SPSMF_SAPI_PROPERTIES',
    'SDA_Consume_Leading_Spaces', 'DISPID_SPRulesCount', 'SVP_8',
    'SVP_10', 'SSTTTextBuffer', 'SPPHRASEPROPERTY',
    'DISPID_SVPriority', 'SP_VISEME_0', 'SRSEDone',
    'ISpResourceManager', 'DISPID_SpeechCustomStream',
    'SpeechCategoryAudioOut', 'ISpStreamFormatConverter',
    'STCRemoteServer', 'SAFTDefault', 'ISpXMLRecoResult', 'SVP_7',
    'DISPID_SRGRules', 'SpCustomStream', 'DISPID_SADefaultFormat',
    'DISPID_SPRs_NewEnum', 'SDTDisplayText', 'SVEWordBoundary',
    'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SGRName',
    'DISPID_SRCRetainedAudio', 'SRAONone', 'SVP_11',
    'SPINTERFERENCE_TOOLOUD', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPEI_PHONEME', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SVSInputSentenceLength', 'DISPID_SPAPhraseInfo',
    'SDTRule', 'SPGRAMMARSTATE', 'SRCS_Disabled', 'SPSSuppressWord',
    'SRAImport', 'SRADynamic', 'SVEAudioLevel', 'SPEI_RECOGNITION',
    'SAFTCCITT_uLaw_11kHzMono', 'SRSInactive', 'DISPID_SVEPhoneme',
    'SPSHT_OTHER', 'DISPID_SVEEnginePrivate',
    'DISPID_SPIGetDisplayAttributes', 'SRTStandard',
    'SAFT24kHz16BitMono', 'DISPID_SPPFirstElement', 'DISPID_SVResume',
    'DISPID_SPPsCount', 'SpeechCategoryAppLexicons',
    'DISPID_SpeechPhraseBuilder', 'SGDSActiveUserDelimited', 'SASRun',
    'SpeechRunState', 'LONG_PTR', 'SRAExport',
    'ISpeechPhraseReplacements', 'eLEXTYPE_PRIVATE8', 'SPRULESTATE',
    'DISPID_SVSInputWordPosition', 'DISPID_SPIProperties',
    'SAFT12kHz8BitStereo', 'SpeechVoiceSpeakFlags',
    'DISPID_SDKSetLongValue', 'SPCT_SUB_DICTATION', 'SINone',
    'SPAO_RETAIN_AUDIO', 'DISPID_SRSetPropertyString',
    'SECHighConfidence', 'ISpGrammarBuilder', 'SP_VISEME_12',
    'DISPID_SRAudioInput', 'SVP_1', 'ISpPhraseAlt',
    'DISPID_SVSInputSentencePosition', 'DISPID_SVEStreamStart',
    'DISPID_SOTRemove', 'SPPS_Noncontent',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SLAddPronunciation',
    'ISpRecoContext2', 'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPIStartTime',
    'SASStop', 'SGPronounciation', 'ISpeechRecoContext',
    'DISPID_SPEAudioSizeTime', 'IEnumString', 'SP_VISEME_3',
    'SVSFParseMask', 'SP_VISEME_15', 'ISpEventSink', 'SPXRO_SML',
    'SPEI_FALSE_RECOGNITION', 'SPSMF_UPS', 'SSSPTRelativeToEnd',
    'STCInprocHandler', 'DISPID_SVEventInterests',
    ...
    'DISPID_SRRRecoContext', 'DISPID_SRCERequestUI',
    'SPEI_SR_RETAINEDAUDIO', 'SWPUnknownWordUnpronounceable',
    'ISpNotifyTranslator', 'DISPID_SRGId', 'SBOPause',
    'SPRS_INACTIVE', 'DISPID_SOTCId', 'SGRSTTRule',
    'DISPID_SASCurrentSeekPosition', 'ISpeechWaveFormatEx',
    'SpeechInterference', 'DISPID_SGRsCommit', 'DISPID_SRCState',
    'SpeechMicTraining', 'Speech_Max_Pron_Length', 'STCLocalServer',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SGRsCommitAndSave',
    'DISPID_SRRGetXMLResult', 'DISPID_SAFSetWaveFormatEx',
    'IInternetSecurityMgrSite', 'DISPID_SVEStreamEnd',
    'DISPID_SPPChildren', 'SPFILEMODE', 'SAFT12kHz8BitMono',
    'ISpNotifySink', 'ISpPhrase',
    'DISPID_SLRemovePronunciationByPhoneIds', 'eLEXTYPE_PRIVATE17',
    'DISPID_SRCVoice', 'DISPID_SRState', 'DISPID_SVAlertBoundary',
    'DISPID_SPIElements', 'SVSFPurgeBeforeSpeak', 'SGDSInactive',
    'SPCT_DICTATION', 'SPAO_NONE', 'eLEXTYPE_RESERVED4',
    ...
    'ISpeechRecognizerStatus', 'SAFT44kHz8BitMono',
    'SAFT24kHz8BitMono', 'ISpSerializeState', 'DISPID_SGRSTs_NewEnum',
    'SpeechStreamFileMode', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SVSFVoiceMask', 'DISPID_SDKGetStringValue', 'STCInprocServer',
    'DISPID_SPRuleChildren', 'IEnumSpObjectTokens', 'SPAR_Medium',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SBSWrite',
    'SVEAllEvents', 'DISPID_SOTGetDescription',
    'DISPID_SDKSetStringValue', 'SPCT_COMMAND', 'DISPID_SRCPause',
    'SVP_19', 'SPEI_TTS_PRIVATE', 'DISPID_SPEDisplayAttributes',
    'ISpeechRecoGrammar', 'ISpMMSysAudio', 'SAFTCCITT_ALaw_8kHzMono',
    'ISpRecoGrammar2', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SPEPronunciation', 'DISPID_SpeechPhraseElement', 'SVP_17',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SOTCEnumerateTokens',
    'SpeechRetainedAudioOptions', 'SPBO_NONE', 'SPSHORTCUTPAIRLIST',
    'SP_VISEME_9', 'DISPID_SPPNumberOfElements',
    'ISpeechGrammarRules', 'SPEI_SR_BOOKMARK', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SGRSTType', 'SpeechCategoryPhoneConverters',
    'SPEI_RESERVED1', 'SPRST_INACTIVE',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'Speech_Default_Weight',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SRGetPropertyString',
    'DISPID_SPRuleNumberOfElements', 'SSTTDictation',
    'DISPID_SLGetWords', 'DISPID_SRGDictationSetState',
    'SpeechPropertyResourceUsage', 'DISPID_SpeechRecoContext',
    'DISPID_SVGetProfiles', 'DISPID_SMSALineId',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SGRAddState',
    'DISPID_SGRSTPropertyName', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SPERequiredConfidence', 'SPINTERFERENCE_TOOSLOW',
    'SPWORDPRONUNCIATION', 'DISPID_SpeechPhraseProperties',
    'DISPID_SRDisplayUI', 'SpeechVoiceEvents', 'SpeechRuleAttributes',
    'DISPID_SpeechLexiconWords', 'SVP_3', 'SGLexical', 'SPLO_STATIC',
    'SVSFIsNotXML', 'SPDKL_CurrentUser', 'SpeechUserTraining',
    'SP_VISEME_6', 'eLEXTYPE_PRIVATE6', 'SpeechRecoProfileProperties',
    'SPEI_START_SR_STREAM', 'SPRECOCONTEXTSTATUS',
    'DISPID_SGRSAddWordTransition', 'SPPS_Verb',
    'SVSFParseAutodetect', 'SpeechStreamSeekPositionType',
    'SAFT22kHz8BitMono', 'eLEXTYPE_RESERVED9',
    'DISPID_SpeechXMLRecoResult', 'SAFT48kHz16BitStereo',
    'SpInprocRecognizer', 'DISPID_SpeechVoiceEvent',
    'DISPID_SRGCmdLoadFromFile', 'eLEXTYPE_PRIVATE1',
    'SAFTCCITT_uLaw_11kHzStereo', 'SP_VISEME_18',
    ...
    'SVEVoiceChange', 'SPEVENT', 'SpeechEmulationCompareFlags',
    'STSF_LocalAppData', 'SWTAdded', 'SVP_20',
    'DISPID_SVGetAudioInputs', 'DISPID_SOTCGetDataKey',
    'SPGRAMMARWORDTYPE', 'DISPID_SVSkip', 'DISPID_SpeechAudioFormat',
    'eLEXTYPE_PRIVATE15', 'DISPID_SAFGetWaveFormatEx', 'SPCS_ENABLED',
    'SpMemoryStream', 'SPEVENTENUM', 'DISPID_SLPPartOfSpeech',
    ...
    'SAFTCCITT_ALaw_8kHzStereo', 'SVPNormal', 'DISPID_SOTSetId',
    'eLEXTYPE_RESERVED10', 'SpFileStream', 'DISPID_SRRAlternates',
    ...
    'SPCATEGORYTYPE', 'DISPID_SLPPhoneIds', 'DISPID_SGRSTWeight',
    'eLEXTYPE_PRIVATE20', 'SAFTADPCM_44kHzMono',
    'DISPID_SRCEAdaptation', 'DISPID_SAEventHandle', 'SVSFPersistXML',
    'SPTEXTSELECTIONINFO', 'SECFDefault', 'SPLO_DYNAMIC',
    'SpStreamFormatConverter', 'SpLexicon', 'SRAInterpreter',
    'DISPID_SVGetAudioOutputs', 'SPRST_ACTIVE', 'SDKLCurrentUser',
    'DISPID_SpeechPhraseElements', 'SREPropertyNumChange', 'SpVoice',
    'DISPID_SRCSetAdaptationData', 'SDTPronunciation',
    'SDTAlternates', 'DISPID_SRCERecognizerStateChange',
    'SpeechAudioFormatGUIDText', 'SAFT44kHz8BitStereo',
    'SPBO_TIME_UNITS', 'DISPID_SOTGetAttribute', 'ISpRecognizer2',
    'DISPID_SRSSupportedLanguages', 'DISPID_SRCreateRecoContext',
    'DISPID_SPRules_NewEnum', 'ISpVoice', 'eLEXTYPE_APP',
    'DISPID_SRAudioInputStream', 'SSTTWildcard', 'SpeechLexiconType',
    ...
    'DISPID_SPRDisplayAttributes', 'SP_VISEME_5',
    'DISPID_SVSpeakStream', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SBSFormat',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SVP_6', 'DISPID_SAVolume',
    'SPEI_SR_PRIVATE', 'DISPID_SGRSTransitions', 'SPCS_DISABLED',
    'SpeechAudioFormatGUIDWave', 'DISPID_SGRAttributes',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SASCurrentDevicePosition',
    'SAFTCCITT_ALaw_44kHzMono', 'SPINTERFERENCE',
    'DISPID_SGRSTPropertyValue', 'SPEI_RESERVED5', 'SPRS_ACTIVE',
    'SAFT32kHz16BitStereo', 'ISpNotifySource',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'ISpeechVoice',
    'eLEXTYPE_PRIVATE3', 'SAFT48kHz8BitStereo', 'SVEBookmark',
    'ISpeechFileStream', 'SPVISEMES', 'DISPID_SOTMatchesAttributes',
    'DISPID_SpeechPhraseRules', 'ISpeechAudioStatus',
    'DISPID_SRGCmdLoadFromObject', 'SPPS_SuppressWord',
    'WAVEFORMATEX', 'SpeechCategoryAudioIn', 'SGRSTTWord',
    'SAFTTrueSpeech_8kHz1BitMono', 'SDTReplacement',
    'DISPID_SDKCreateKey', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SPWF_INPUT', 'SVP_4', 'Speech_StreamPos_Asap', 'SRCS_Enabled',
    'SPEI_PHRASE_START', 'eLEXTYPE_VENDORLEXICON',
    'SECFIgnoreKanaType', 'SAFT11kHz8BitMono', 'SVEViseme',
    'SAFT44kHz16BitStereo', 'ISpeechXMLRecoResult',
    'DISPID_SRCEInterference', 'eLEXTYPE_PRIVATE2',
    'SPRECOGNIZERSTATUS', 'SpeechDiscardType',
    'SpeechTokenIdUserLexicon', 'SPPHRASE', 'SPEI_HYPOTHESIS',
    'SDKLDefaultLocation', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SPEsCount', 'DISPID_SPERetainedStreamOffset',
    'ISpObjectTokenCategory', 'SVSFParseSapi', 'ISpShortcut',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SPEsItem',
    'DISPID_SOTRemoveStorageFileName', 'ISpeechBaseStream',
    'DISPID_SRGetFormat', 'DISPID_SPRulesItem', 'SREStreamStart',
    'SLTUser', 'SPAS_RUN', 'SpWaveFormatEx', 'SVSFNLPMask',
    'SpeechTokenKeyAttributes', 'DISPID_SRRSetTextFeedback',
    'SREPrivate', 'SAFTADPCM_22kHzMono', 'SpeechPartOfSpeech',
    'SPEI_MAX_TTS', 'SSFMOpenReadWrite', 'ISpeechVoiceStatus',
    'SINoise', 'ISpeechPhraseAlternates',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SGRs_NewEnum',
    'SAFT24kHz8BitStereo', 'SPWT_PRONUNCIATION', 'SGRSTTTextBuffer',
    'DISPID_SRCEAudioLevel', 'SVSFIsFilename', 'DISPID_SRCEEndStream',
    'DISPID_SpeechFileStream', 'SpPhoneticAlphabetConverter',
    'ISpeechGrammarRule', 'SPSFunction', 'ISpeechPhraseAlternate',
    'DISPID_SLPsCount', 'DISPID_SMSGetData', 'SRTExtendableParse',
    'SPSHT_NotOverriden', 'SVP_15', 'DISPID_SRGState',
    'DISPID_SpeechDataKey', 'SRSInactiveWithPurge',
    'DISPID_SGRSTsCount', 'DISPID_SVDisplayUI', 'SPEVENTSOURCEINFO',
    'DISPID_SGRsFindRule', 'DISPID_SRCBookmark', 'ISpStreamFormat',
    'DISPID_SPIGrammarId', 'eLEXTYPE_RESERVED6',
    'SAFT11kHz16BitStereo', 'SLOStatic', 'SPRECOSTATE',
    'DISPID_SPAs_NewEnum', 'ISpPhoneConverter', 'DISPID_SGRsCount',
    ...
    'SP_VISEME_8', 'ISpeechGrammarRuleStateTransition',
    'SGRSTTDictation'
]
